...
#include "Discrete_conformal_map_parameterizer_3.h"
#include "Discrete_authalic_parameterizer_3.h"
#include "Iterative_smi_parameterizer_3.h"
#include "Iterative_optimal_parameterizer_3.h"
#include "Iterative_parameterize.h"
...
typedef CGAL::Surface_mesh<Kernel::Point_3>                               PolyMesh;
...
typedef PolyMesh::Property_map<vertex_descriptor,  int>          Vertex_int_map;
...
int main(int argc, char** argv)
{
   ...
   */
  Vertex_int_map vimap = sm.add_property_map<vertex_descriptor, int>("v:index").first;
  // or else add content to the created map
  int i = 0;
  ...
  //typedef SMP::Iterative_smi_parameterizer_3<PolyMesh, Border_parameterizer> Parameterizer;
  typedef SMP::Iterative_optimal_parameterizer_3<PolyMesh, Border_parameterizer> Parameterizer;
  ...
  int iterations = 30;
  SMP::Error_code err = SMP::parameterize(sm, Parameterizer(border_param), bhd, uv_map, iterations);
